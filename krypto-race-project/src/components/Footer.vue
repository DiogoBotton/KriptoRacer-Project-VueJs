<template>
  <v-footer dark padless class="background-footer">
    <v-card flat tile class="white--text text-center">
      ...
      <v-card-text class="white--text">
        {{ new Date().getFullYear() }} — <strong>KriptoRacer</strong>
      </v-card-text>
    </v-card>
  </v-footer>
</template>
...
export default {
  data: () => ({
    icons: [
        {icon: "mdi-facebook", link: "https://www.google.com.br"}, 
        {icon: "mdi-twitter", link: "https://www.google.com.br"},
        {icon: "mdi-linkedin", link: "https://www.google.com.br"},
        {icon: "mdi-instagram", link: "https://www.google.com.br"},
    ],
  }),
};
</script>
